...
const btn = tv({
  ...
  variants: {
    color: {
      light: 'bg-white text-gray-800 border-gray-400 hover:bg-gray-100 focus:ring-indigo-600',
      dark: 'text-white bg-neutral-800 border-neutral-800 focus:ring-neutral-800',
      primary: 'bg-indigo-600 border-indigo-600 text-white hover:bg-indigo-700 focus:ring-indigo-600',
      secondary: 'bg-gray-600 border-gray-600 text-white hover:bg-gray-700 focus:ring-gray-600',
      warning: 'bg-amber-500 border-amber-500 text-white hover:bg-amber-600 focus:ring-amber-500',
      error: 'bg-rose-600 border-rose-600 text-white hover:bg-rose-700 focus:ring-rose-600',
      success: 'bg-green-600 border-green-600 text-white hover:bg-green-700 focus:ring-green-600',
    },
    size: {
